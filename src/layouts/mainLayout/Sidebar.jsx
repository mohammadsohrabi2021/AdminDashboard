...
//           <p className="mb-0 pt-3" style={{ fontSize: "90%" }}>
...
const Sidebar = () => {
  ...
  const { t } = useTranslation();
  return (
    <Grid className={`sidebar ${!showSidebar ? "collapsed" : ""}`}>
      <Grid className="sidebar-content">
        <a className="sidebar-brand d-flex flex-column align-items-center pt-3 mb-0">
          <img src={logo} style={{ height: "80px" }} />
          <p className="mb-0 pt-3" style={{ fontSize: "90%" }}>
            {t("mainLayout.sidebar.subtitle")}
                ...
                {item.mune.map((itemMune) => (
                  <li key={itemMune.id} className="sidebar-item">
                    ...
                    >
                      ...
                      >
                        {t(`mainLayout.sidebar.${itemMune.name}`)}
                      </span>
                    </NavLink>
                  </li>
                ))}
